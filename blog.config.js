...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Morris', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '408 408', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lphblog.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Morris, 博客', // 网站关键词 英文逗号隔开
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://npm.elemecdn.com/prism-themes/themes/prism-vsc-dark-plus.css', // 代码块默认主题
  PRISM_THEME_SWITCH: process.env.NEXT_PUBLIC_PRISM_THEME_SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM_THEME_LIGHT_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_LIGHT_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-vsc-dark-plus.css', // 浅色模式主题
  PRISM_THEME_DARK_PATH:
    process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH ||
    'https://npm.elemecdn.com/prism-themes/themes/prism-vsc-dark-plus.css', // 深色模式主题
